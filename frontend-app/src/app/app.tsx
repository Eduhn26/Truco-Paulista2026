  ...
  return (
    <div className="relative min-h-screen bg-[#050810] text-slate-100 selection:bg-amber-500/30 selection:text-white">
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZyI+PGNpcmNsZSBjeD0iMSIgY3k9IjEiIHI9IjEiIGZpbGw9InJnYmEoMjAxLCAxNjgsIDc2LCAwLjA0KSIvPjwvc3ZnPg==')] opacity-40" />
      </div>
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#050810]/80 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 lg:px-6">
          <Link to="/" className="group inline-flex items-center gap-3 transition">
            ...
            <span className="hidden text-sm font-bold tracking-tight text-slate-200 group-hover:text-white sm:inline">
              Truco Paulista
            </span>
          </Link>
            ...
            <div className="hidden items-center gap-2 rounded-xl border border-white/5 bg-white/[0.03] px-3 py-1.5 sm:flex">
              <span
                className={`h-1.5 w-1.5 rounded-full ${
                  isAuthenticated ? 'bg-green-500' : 'bg-amber-500/60'
                }`}
              />

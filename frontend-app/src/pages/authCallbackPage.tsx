...
export function AuthCallbackPage() {
    ...
    return (
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at 50% 50%, rgba(153,27,27,0.12) 0%, transparent 65%)',
          }}
        />
  ...
  return (
    <main
      ...
      style={{
        background:
          'radial-gradient(ellipse at 50% -10%, #0d2318 0%, #050810 50%, #040610 100%)',
      }}
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at 50% 50%, rgba(15,61,30,0.55) 0%, rgba(8,32,16,0.35) 100%)',
        ...
        >
          <div
            ...
            style={{
              width: '65%',
              background:
                'linear-gradient(90deg, transparent, #c9a84c, #e8c76a, #c9a84c, transparent)',
        ...
        <Link
          to="/"
          className="mt-8 inline-block text-[10px] font-black uppercase transition-colors"
          style={{
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <span
        style={{
          fontSize: 12,
          color: status === 'pending' ? 'rgba(255,255,255,0.3)' : 'rgba(255,255,255,0.58)',

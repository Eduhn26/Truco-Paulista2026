...
import type { DeclineBetResponseDto } from '@game/application/dtos/responses/decline-bet.response.dto';
...
export class DeclineBetUseCase {
  constructor(private readonly matchRepository: MatchRepository) {}

  async execute(request: DeclineBetRequestDto): Promise<DeclineBetResponseDto> {

...
import type { RaiseToSixResponseDto } from '@game/application/dtos/responses/raise-to-six.response.dto';
...
export class RaiseToSixUseCase {
  constructor(private readonly matchRepository: MatchRepository) {}

  async execute(request: RaiseToSixRequestDto): Promise<RaiseToSixResponseDto> {
